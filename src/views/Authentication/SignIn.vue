  ...
  >
    ...
    <div>
      <form action="" class="flex flex-col items-start ">
        <input type="email" placeholder="Email" class="form-input my-3 p-3 w-full sm:p-2.5" />
        <input type="password" placeholder="Password" class="form-input my-3 p-3 w-full sm:p-2.5" />
        ...
        <buttonOrange class="w-full p-3 my-3 hover:bg-[rgba(249,171,0,0.05)] trnsition duration-300 sm:p-2">
            SIGN IN
        </buttonOrange>
      </form>
    </div>
    <span class="flex justify-center text-lg">or</span>
    <div class="my-3">
        <BrandIcon/>
    </div>
